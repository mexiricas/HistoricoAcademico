 ...
 * @author Denis
 */
public class MyConnectionPostgresSQL implements Serializable{
    ...
    public MyConnectionPostgresSQL() {
    ...
    public boolean conecta() {
        ...
        String conexao = "jdbc:postgresql://localhost:5432/historicoacademico";
        try {
